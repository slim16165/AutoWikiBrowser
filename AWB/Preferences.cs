...
internal sealed partial class MyPreferences : Form
{
    ...
    public string Language => cmboLang.SelectedItem == null ? "" : cmboLang.SelectedItem.ToString();

    public ProjectEnum Project => (ProjectEnum)Enum.Parse(typeof(ProjectEnum), cmboProject.SelectedItem.ToString());
    ...
    public int PrefOnLoad
    {
        ...
        get => (cmboOnLoad.SelectedIndex == 2 ? 0 : cmboOnLoad.SelectedIndex);
