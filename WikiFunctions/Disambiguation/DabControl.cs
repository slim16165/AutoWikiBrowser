...
public partial class DabControl : UserControl
{
    ...
    public string Result => txtCorrection.Text;

    /// <summary>
    /// Returns whether this disambiguation makes a change
    /// </summary>
    public bool NoChange => cmboChoice.SelectedIndex == 0 && txtCorrection.Text == Surroundings;
    ...
    public bool CanSave => !string.IsNullOrEmpty(txtCorrection.Text.Trim());
