...
public partial class PageContainsControl : UserControl
{
    ...
    {
        get => txtContains.Text;
        set => txtContains.Text = value;
    }

    public bool IsRegex
    {
        get => chkIsRegex.Checked;
    ...
    public bool After
    {
        get => chkAfterProcessing.Checked;
    ...
    /// 
    /// </summary>
    public virtual string SkipReason => "Page contains: " + txtContains.Text;
}