...
internal abstract class PluginBase
{
    ...
    protected virtual string ParameterBreak => Environment.NewLine;
    ...
    protected internal virtual bool AmGeneric => false;
    ...
    protected bool HasAlternateNames => (PreferredTemplateNameRegex != null);
    ...
    protected string RedirectsParm => PreferredTemplateName.Replace(" ", "") + "RedirN";
}
