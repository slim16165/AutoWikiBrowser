...
{    /* This class will:
    ...
    */
    ...
    public static string AWBLoggingEditSummary => "(" + Variables.WPAWB + " Logging) ";
    ...
    public string TimeStamp => GetSubItemText(SubItem.TimeStamp);
    ...
    public static new ListViewSubItemCollection SubItems => throw new NotImplementedException("The SubItems property should not be accessed directly");
}