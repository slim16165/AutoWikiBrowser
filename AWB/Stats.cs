...
internal static class UsageStats
{
    ...
    private static string UserName => Variables.MainForm.TheSession.User.Name;
    ...
    static bool NewPluginsAdded =>
        NewAWBPlugins.Count > 0 || NewAWBBasePlugins.Count > 0
    ...
    /// </summary>
    private static bool EstablishedContact => (RecordId > 0);
