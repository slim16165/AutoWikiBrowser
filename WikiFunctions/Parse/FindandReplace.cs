...
public partial class FindandReplace : Form
{
    ...
    /// </summary>
    public static string Arrow => Variables.RTL ? " ← " : " → ";
    ...
    /// </summary>
    public int NoOfReplacements => _replacementList.Count;

    /// <summary>
    /// Returns whether there are any replacements (enabled and disabled)
    /// </summary>
    public bool HasReplacements => NoOfReplacements != 0;

    /// <summary>
    /// Returns whether any of the enabled find & replace entries are specified to be run 'after processing'
    /// </summary>
    public bool HasAfterProcessingReplacements => HasProcessingReplacements(true);
