...
public static partial class Variables
{
    ...
    public static string Revision =>
        // see SvnInfo.template.cs for details
        !m_Revision.Contains("$") ? m_Revision.Replace("/", "-") : "?";
    ...
    public static string Host => new Uri(URL).Host;

    /// <summary>
    /// Returns the script path of the site, e.g. /w
    /// </summary>
    public static string ScriptPath => URLEnd.Substring(0, URLEnd.LastIndexOf('/'));
    ...
    /// </summary>
    public static bool IsWikimediaProject => Project <= ProjectEnum.commons;

    /// <summary>
    /// Returns true if we are currently editing the English Wikipedia
    /// </summary>
    public static bool IsWikipediaEN => Project == ProjectEnum.wikipedia && LangCode.Equals("en");

    /// <summary>
    /// Returns true if we are currently editing Commons
    /// </summary>
    public static bool IsCommons => Project == ProjectEnum.commons;

    /// <summary>
    /// Returns true if we are currently a monolingual Wikimedia project
    /// </summary>
    public static bool IsWikimediaMonolingualProject => Project >= ProjectEnum.species && Project < ProjectEnum.wikia;

    /// <summary>
    /// Returns true if we are currently editing a "custom" wiki
    /// </summary>
    public static bool IsCustomProject => Project == ProjectEnum.custom;

    /// <summary>
    /// Returns true if we are currently editing a Wikia/Fandom site
    /// </summary>
    public static bool IsWikia => Project == ProjectEnum.wikia || Project == ProjectEnum.fandom;
