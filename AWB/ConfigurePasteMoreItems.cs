...
public partial class ConfigurePasteMoreItems : Form
{
    ...
    public string String1 { get => textBox1.Text;
        private set => textBox1.Text = value;
    }
    public string String2 { get => textBox2.Text;
        private set => textBox2.Text = value;
    }
    public string String3 { get => textBox3.Text;
        private set => textBox3.Text = value;
    }
    public string String4 { get => textBox4.Text;
        private set => textBox4.Text = value;
    }
    public string String5 { get => textBox5.Text;
        private set => textBox5.Text = value;
    }
    public string String6 { get => textBox6.Text;
        private set => textBox6.Text = value;
    }
    public string String7 { get => textBox7.Text;
        private set => textBox7.Text = value;
    }
    public string String8 { get => textBox8.Text;
        private set => textBox8.Text = value;
    }
    public string String9 { get => textBox9.Text;
        private set => textBox9.Text = value;
    }
    public string String10 { get => textBox10.Text;
