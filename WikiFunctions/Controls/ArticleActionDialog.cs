...
public partial class ArticleActionDialog : Form
{
    ...
    public bool AutoProtectAll => chkAutoProtect.Checked;

    public string NewTitle
    {
        get => txtNewTitle.Text;
        set => txtNewTitle.Text = value;
    }

    public string Summary
    {
        get => cmboSummary.Text;
        set => cmboSummary.Text = value;
    }

    public string EditProtectionLevel
    {
        get => CurrentAction == ArticleAction.Protect ? MoveDelete.EditProtectionLevel : "";
        set => MoveDelete.EditProtectionLevel = value;
    }

    public string MoveProtectionLevel
    {
        get => CurrentAction == ArticleAction.Protect ? MoveDelete.MoveProtectionLevel : "";
        set => MoveDelete.MoveProtectionLevel = value;
    }

    public string ProtectExpiry => txtExpiry.Text;

    public bool CascadingProtection => chkCascadingProtection.Checked;

    public bool NoRedirect => chkNoRedirect.Checked;

    public bool Watch => chkWatch.Checked;

    public bool DealWithAssocTalkPage => chkDealWithAssoc.Checked;
