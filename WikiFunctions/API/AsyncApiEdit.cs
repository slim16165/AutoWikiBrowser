...
public class AsyncApiEdit
{
    ...
    /// </summary>
    public bool IsActive => State == EditState.Working;
    ...
    public string URL => SynchronousEditor.URL;

    public string ApiURL => SynchronousEditor.ApiURL;

    public bool PHP5 => SynchronousEditor.PHP5;

    public int Maxlag
    {
        get => SynchronousEditor.Maxlag;
        set => SynchronousEditor.Maxlag = value;
    }

    public bool NewMessageThrows
    {
        get => SynchronousEditor.NewMessageThrows;
        set => SynchronousEditor.NewMessageThrows = value;
    }

    public string Action => SynchronousEditor.Action;

    public string HtmlHeaders => SynchronousEditor.HtmlHeaders;

    public PageInfo Page => SynchronousEditor.Page;
    ...
    public UserInfo User => SynchronousEditor.User;
