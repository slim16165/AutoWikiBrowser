...
public sealed class PluginManager : IAWBPlugin
{
    ...
    // AWB interface:
    public string Name => Constants.AWBPluginName;
    ...
    internal static bool BotMode => AWBForm.BotModeCheckbox.Checked;

    internal static string PluginName => Me;
    ...
    public string WikiName => Constants.WikiPlugin + " version " + AboutBox.Version;
