...
internal sealed partial class SkipOptions : Form, ISkipOptions
{
    ...
    public bool SkipNoBoldTitle => skipListBox.GetItemChecked(0);

    public bool SkipNoBulletedLink => skipListBox.GetItemChecked(1);

    public bool SkipNoBadLink => skipListBox.GetItemChecked(2);

    public bool SkipNoUnicode => skipListBox.GetItemChecked(3);

    public bool SkipNoTag => skipListBox.GetItemChecked(4);

    public bool SkipNoHeaderError => skipListBox.GetItemChecked(5);

    public bool SkipNoDefaultSortAdded => skipListBox.GetItemChecked(6);

    public bool SkipNoUserTalkTemplatesSubstd => skipListBox.GetItemChecked(7);

    public bool SkipNoCiteTemplateDatesFixed => skipListBox.GetItemChecked(8);

    public bool SkipNoPeopleCategoriesFixed => skipListBox.GetItemChecked(9);
