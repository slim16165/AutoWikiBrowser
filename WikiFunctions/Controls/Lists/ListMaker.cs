...
public partial class ListMaker : UserControl, IList<Article>
{
    ...
    /// </summary>
    public int Count => lbArticles.Items.Count;
    ...
    {
        get => (Article)lbArticles.Items[index];
    ...
    /// </summary>
    public ListBox Items => lbArticles;
    ...
    {
        get => cmboSourceSelect.SelectedItem.GetType().Name;
        set
        {
            int index;
    ...
    /// </summary>
    public int NumberOfArticles => lbArticles.Items.Count;
