...
partial class MainForm
{
    ...
    TabPage IAutoWikiBrowserTabs.MoreOptionsTab => tpMoreOptions;
    TabPage IAutoWikiBrowserTabs.OptionsTab => tpOptions;
    TabPage IAutoWikiBrowserTabs.SkipTab => tpSkip;
    TabPage IAutoWikiBrowserTabs.StartTab => tpStart;
    TabPage IAutoWikiBrowserTabs.DabTab => tpDab;
    TabPage IAutoWikiBrowserTabs.BotTab => tpBots;
