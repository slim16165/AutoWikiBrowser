...
class TypoScanBasePlugin : IAWBBasePlugin
{
    ...
    public string Name => "TypoScan Plugin";

    public string WikiName =>
        "[[Wikipedia:TypoScan|TypoScan AWB Plugin]], Plugin version " +
    ...
    internal static int EditAndIgnoredPages => SavedPages.Count + SkippedPages.Count;
}